...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            alert(`Thank you for your message, ${name}! We received your inquiry about "${subject}" and will get back to you at ${email} soon.`);
            
            // Reset form
            contactForm.reset();
            
            // Log the data (in real application, send to backend)
